...
namespace QLcuahangbanmaytinh
{
    ...
    {
        static string strConnect = @"Data Source=HP\SQLEXPRESS;Initial Catalog=QLcuahangmaytinh;Integrated Security=True";
        ...
        {
            //Bƣớc 1: Kết nối tới CSDL (Gọi phƣơng thức KetNoi) 
            KetNoi();
