...
namespace QLcuahangbanmaytinh
{
    public partial class frmQLthongtinmaytinh : Form
    {
        ...
        {
            co.KetNoi();
            dgvmaytinh.DataSource = co.GetData("select * from ThongTinMT");
            co.NgatKetNoi();
        }
        ...
        {
            string sqlthem = "insert into ThongTinMT values ('" + txtmamaytinh.Text + "','" + txttenmaytinh.Text
        ...
        private void frmQLthongtinmaytinh_Load(object sender, EventArgs e)
        {
            ...
            cbomancc.DataSource = co.GetData("select * from NhaCC");
        ...
        private void btnsua_Click(object sender, EventArgs e)
        {
            ...
            string sqlsua = "update ThongTinMT set MaMT='" + txtmamaytinh.Text + "',tenmt='" + txttenmaytinh.Text
        ...
        private void btnxoa_Click(object sender, EventArgs e)
        {
           ...
           MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
            ...
            {
                string sqlxoa = "delete from ThongtinMT where MaMT = '" + txtmamaytinh.Text + "'";
                co.ThucThi(sqlxoa);
            }
            frmQLthongtinmaytinh_Load(sender, e);
