...
namespace QLcuahangbanmaytinh
{
    public partial class frmnhacungcap : Form
    {
        ...
        {
            co.KetNoi();
            dgvncc.DataSource = co.GetData("select * from NhaCC");
            co.NgatKetNoi();
        }
        ...
        {
            string sqlthem = "insert into NhaCC values ('" + txtmancc.Text + "','" + txttenncc.Text
        ...
        private void btnsua_Click(object sender, EventArgs e)
        {
            ...
            string sqlsua = "update NhaCC set MaNCC='" + txtmancc.Text + "',TenNCC='" + txttenncc.Text
        ...
        private void btnxoa_Click(object sender, EventArgs e)
        {
           ...
           MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
            ...
            {
                string sqlxoa = "delete from NhaCC where MaNCC = '" + txtmancc.Text + "'";
                co.ThucThi(sqlxoa);
            }
            frmnhacungcap_Load(sender, e);
